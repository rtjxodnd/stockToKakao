from stockToKakao.p11_get_filltered_big_stock_info.crawler.crawlStockDetailInfo import getStockDetailInfo
from stockToKakao.p11_get_filltered_big_stock_info.crawler.crawlDailyStockInfo import main_process as maxVolumeCrawler
